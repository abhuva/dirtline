...
int tile_slots() { return wasteland_art::tile_slots; }
int resident_tile_count() { return wasteland_art::unique_tiles; }
...
int surface_at(int x,int y) {
    ...
    return wasteland::surface_at(x,y);
}
...
const bn::tile* tiles() { return wasteland_art::tiles; }
const bn::color* palette() { return wasteland_art::palette; }
int palette_colors() { return wasteland_art::palette_colors; }
}
