"""Smoke test an actual ROM built with maps/recipes/natural-ground.json."""
import hashlib
import json
import struct
...
try:
    ...
    t.check('Leaving wasteland releases layout and custom ground grid',state['layout_bytes']==0,state['layout_bytes'])
